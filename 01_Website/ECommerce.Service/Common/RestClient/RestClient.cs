...
namespace ECommerce.Facade.Common.RestClient
{
    public class RestClient
    {
        ...
        {
            string no = ConstValue.UserSysNo;
            int userSysNo;
            ...
            string acct = ConstValue.UserAcct;
        ...
        private void HandlePostRequestHeader(HttpRequest request, string operating)
        {
            ...
            request.Headers["X-User-Acct"] = HttpUtility.UrlEncode(m_UserAcct);
        ...
        private string HandleGetRequestUrl(string url)
        {
            if (url != null && url.Length > 0)
            {
                ...
                string language = this.m_LanguageCode;
