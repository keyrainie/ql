...
namespace ECommerce.Utility.DataAccess
{
    public class DataCommand
    {
        ...
        private void SetAutoValueParameter(List<DbParameter> parameterList, string[] propertyNameList)
        {
            for (int i = 0; i < m_DbParameterList.Count; i++)
            {
                ...
                if (ConfigHelper.IsKeyWord(property, out keyword))
                {
                    ...
                    {
                        m_DbParameterList[i].Value = ContextManager.Current.UserSysNo;
                    }
        ...
        {
            m_Config.CommandText = m_Config.CommandText.Replace(paramName, ContextManager.Current.UserSysNo.ToString());
        }
        ...
        {
            SetParameterValue(paramName, ContextManager.Current.UserSysNo.ToString());
        }
