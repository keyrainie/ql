...
{
    public class ProductMatchedTradingReplyInfo
    {
        public ProductMatchedTradingReplyInfo()
        {
        ...
        private int sysNo;
        private int matchedTradingSysNo;
        ...
        public int MatchedTradingSysNo
        {
            get { return matchedTradingSysNo; }
            set { matchedTradingSysNo = value; }
        }
