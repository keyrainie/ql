...
namespace ECCentral.Portal.UI.PO.Models
{
    public class VendorAgentInfoVM : ModelBase
    {
        ...
        public VendorAgentInfoVM()
        {
            ...
            vendorCommissionInfo = new VendorCommissionInfoVM();
        }
        /// <summary>
        /// 厂商信息
        /// </summary>
        ...
        /// 佣金信息
        /// </summary>
        private VendorCommissionInfoVM vendorCommissionInfo;

        public VendorCommissionInfoVM VendorCommissionInfo
        {
            get { return vendorCommissionInfo; }
            set { base.SetValue("VendorCommissionInfo", ref vendorCommissionInfo, value); }
        }
        ...
        private StoreBrandFilingVM storeBrandFilingInfo;
        public StoreBrandFilingVM StoreBrandFilingInfo
        {
            get { return storeBrandFilingInfo; }
            set { base.SetValue("StoreBrandFilingInfo", ref storeBrandFilingInfo, value); }
        }
    }
}
