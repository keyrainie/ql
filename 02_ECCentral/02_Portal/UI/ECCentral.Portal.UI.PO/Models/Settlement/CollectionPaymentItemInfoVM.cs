...
{
    public class CollectionPaymentItemInfoVM : ModelBase
    {

        public CollectionPaymentItemInfoVM()
        {
        ...
        public decimal? RetailPrice
        {
            ...
            set { base.SetValue("RetailPrice", ref retailPrice, value); }
        }

        /// <summary>
        /// 毛利
        /// </summary>
        private decimal? rateMargin;
        public decimal RateMargin
        {
            get
            {
                return (this.ConsignToAccLogInfo.SalePrice.Value - this.Cost.Value);
            }
            set
            {
                rateMargin = value;
        ...
        private decimal foldCost;
        public decimal FoldCost
        {
            get { return foldCost; }
            set { base.SetValue("FoldCost", ref foldCost, value); }
        }
        ...
        public int ProductQuntity
        {
            ...
            set { base.SetValue("ProductQuntity", ref productQuntity, value); }
        }
    }
}
