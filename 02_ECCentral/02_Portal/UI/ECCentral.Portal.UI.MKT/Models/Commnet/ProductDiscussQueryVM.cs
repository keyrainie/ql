...
{
    public class ProductDiscussQueryVM : ModelBase
    {
        ...
        /// 讨论回复列表
        /// </summary>
        public List<ECCentral.BizEntity.MKT.ProductDiscussReply> ProductDiscussReplyList { get; set; }
        ...
        public bool HasProductDiscussApprovePermission
        {
            get { return AuthMgr.HasFunctionPoint(AuthKeyConst.MKT_ProductDiscuss_Approve); }
        }

        public bool HasProductDiscussCancelPermission
        {
            get { return AuthMgr.HasFunctionPoint(AuthKeyConst.MKT_ProductDiscuss_Cancel); }
        }

        public bool HasProductDiscussReadPermission
        {
            get { return AuthMgr.HasFunctionPoint(AuthKeyConst.MKT_ProductDiscuss_Read); }
        }
