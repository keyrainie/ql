...
{
    public class InventoryAllocatedCardQueryVM : ModelBase
    {
    ...
    public class InventoryAllocatedCardQueryView : ModelBase
    {
        public InventoryAllocatedCardQueryVM QueryInfo
        {
            get;
            set;
        }
        ...
        public InventoryAllocatedCardQueryView()
        {
            QueryInfo = new InventoryAllocatedCardQueryVM();
        }
    }
}
