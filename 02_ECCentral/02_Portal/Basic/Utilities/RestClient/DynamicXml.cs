...
namespace ECCentral.Portal.Basic.Utilities
{
    public class DynamicXml : DynamicObject, INotifyPropertyChanged
    {
        ...
        public class EmptyList : List<dynamic>
        {
            public EmptyList()
                : base(0)
            {
            ...
            public List<dynamic> ToList(string columnName, object columnValue)
            {
                return this;
            }

            public List<dynamic> ToList(Dictionary<string, object> columns)
            {
                return this;
            }
        }
        ...
        private static dynamic ToValue(XElement element)
        {
            ...
            if (str == null || str.Length <= 0)
            {
                ...
                else if (type == XmlType.Enumerable)
                {
            ...
            switch (type)
            {
                ...
                case XmlType.String:
                    return HttpUtility.HtmlDecode(Convert.ToString(str));
                case XmlType.Object:
        ...
        public List<dynamic> ToList(string columnName, object columnValue)
        {
            if (IsArray)
            {
                List<dynamic> list = m_Xml.Elements().Select(x => ToValue(x)).ToList();
            ...
            else
            {
                ...
                return new List<dynamic>(1) { this };
            }
        }
        ...
        public List<dynamic> ToList()
        {
            if (IsArray)
            {
                return m_Xml.Elements().Select(x => ToValue(x)).ToList();
            }
            else
            {
                return new List<dynamic>(1) { this };
        ...
        private void RaisePropertyChanged(string propertyName)
        {
            ...
            {
                var args = new PropertyChangedEventArgs("Item[" + propertyName + "]");
