...
namespace ECCentral.Portal.Basic.Utilities
{
    ...
    public static class EmitHelper
    {
        ...
        public static Type CreateType(Type interfaceType, IMethodEmit methodEmitter, bool isPersist, string prefix)
        {
            ...
            an.Name = prefix;
            AssemblyBuilder asmBuilder = AppDomain.CurrentDomain.DefineDynamicAssembly(an, aba);

            //创建Module
            ModuleBuilder mdlBuilder = asmBuilder.DefineDynamicModule(prefix + ".Module_Impl");
            //if (isPersist)
            //{
