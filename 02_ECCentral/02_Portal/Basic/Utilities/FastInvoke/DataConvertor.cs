    ...
    public static class DataConvertor
    {
        ...
        public static T GetValue<T>(object data, string columnName, string propertyName)
        {
            ...
            try
            {
                ...
                else if (typeof(T) == typeof(ECCentral.BizEntity.LanguageContent) && data is string)
                {
                    return default(T);
                }
                else if (typeof(T) == typeof(CodeNamePair) && (data is string || data is int))
                {
                    return (T)(object)new CodeNamePair() { Code = data.ToString() };
                }
                return (T)data;
            }
            catch
        ...
        public static object GetValueByType(Type destinationType, object data, string columnName, string propertyName)
        {
            if (data == null || data == DBNull.Value)
            {
                return typeof(DataConvertor).GetMethod("GetDefaultValue", BindingFlags.Static | BindingFlags.Public).MakeGenericMethod(destinationType).Invoke(null, null);
            }
            try
            {
                ...
                else if (destinationType == typeof(ECCentral.BizEntity.LanguageContent) && data is string)
                {
                    return new ECCentral.BizEntity.LanguageContent();
                }
                else if (destinationType == typeof(CodeNamePair) && (data is string || data is int))
                {
                    return new CodeNamePair() { Code = data.ToString() };
                }
                return data;
            }
            catch
