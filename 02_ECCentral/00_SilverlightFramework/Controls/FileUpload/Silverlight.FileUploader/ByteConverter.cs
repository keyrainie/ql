...
namespace Newegg.Oversea.Silverlight.FileUploader
{
    ...
    public class NegativeValueToVisibleConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            var result = new ValueToVisibleConverter().Convert(value, targetType, parameter, culture);

            if (result != null)
            {
                return result == "Collapsed" ? "Visible" : "Collapsed";
            }
            return "Collapsed";
        }
