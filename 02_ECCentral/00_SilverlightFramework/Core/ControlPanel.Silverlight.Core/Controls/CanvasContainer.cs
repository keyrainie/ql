...
{
    public class CanvasContainer : Canvas, IContainer
    {
        ...
        public static readonly DependencyProperty ContentProperty = DependencyProperty.Register("Content", typeof(UIElement), typeof(CanvasContainer), null);
        #endregion
