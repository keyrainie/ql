...
namespace Newegg.Oversea.Silverlight.Utilities.Serializer
{
    /// <summary>
    ...
    public static class BinarySerializer
    {
        ...
        public static string GetChecksum(object item)
        {
            ...
            var isChecksum = BinarySerializer.IsChecksum;
            BinarySerializer.IsChecksum = true;
            var toBytes = BinarySerializer.Serialize(item);
            BinarySerializer.IsChecksum = isChecksum;
