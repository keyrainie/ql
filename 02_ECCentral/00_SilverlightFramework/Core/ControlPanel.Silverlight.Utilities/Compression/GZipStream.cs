...
namespace Newegg.Oversea.Silverlight.Utilities.Compression
{
    ...
    ///   <c>Ionic.Silverlight.Compression.GZipStream</c> can compress while writing, or decompress while
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        ///     {
        ///         using (Stream decompressor= new Ionic.Silverlight.Compression.GZipStream(input, CompressionMode.Decompress, true))
        ///         {
        ...
        ///         Using decompressor As Stream = new Ionic.Silverlight.Compression.GZipStream(input, CompressionMode.Decompress, True)
        ...
        #region Silverlight.Compression properties
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == Newegg.Oversea.Silverlight.Utilities.Compression.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == Newegg.Oversea.Silverlight.Utilities.Compression.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == Newegg.Oversea.Silverlight.Utilities.Compression.ZlibBaseStream.StreamMode.Undefined)
            {
