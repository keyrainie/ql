...
namespace ECCentral.Service.Utility
{
    ...
    public class EmailHelper
    {
        ...
        public static void SendEmailByTemplate(string toAddress, string templateID, KeyValueVariables keyValueVariables, bool isInternalMail)
        {
            SendEmailByTemplate(toAddress, string.Empty, string.Empty, templateID, keyValueVariables, null, isInternalMail, true, Thread.CurrentThread.CurrentCulture.Name);
        }
        ...
        private static void CheckMailEntity(MailMessage msg)
        {
