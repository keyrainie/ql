...
namespace ECCentral.BizEntity.Common
{
    ...
    public enum PMQueryType
    {
        ...
        Self,
        /// <summary>
        /// 如果帐号同时是TL，返回自己及自己在PM组中所管理的所有有效状态的PM和其有效状态的备份PM,否则仅自已和有效状态的备份PM
        /// </summary>
        Team,
        /// <summary>
        /// 返回PM列表中所有有效状态的PM
        ...
        AllValid,
        /// <summary>
        /// 返回自己和备份有效状态PM及所有无效状态的PM.
        /// </summary>
        SelfAndInvalid,
        /// <summary>
        /// 返回自己及自己在PM组中所管理的所有有效状态的PM和其有效状态的备份PM及所有无效状态的PM.
        /// </summary>
        TeamAndInvalid,
        /// <summary>
        /// 返回PM列表中所有PM(全部：包括无效)
    ...
    /// ReasonCodeTree 显示方式
    /// </summary>
    public enum ReasonCodeTreeShowType
    {
        /// <summary>
        /// 全部显示
        /// </summary>
    ...
    public enum BizLogType
    {
        ...
        //             财务给系统帐号增加积分  14
        [Description("财务Add NewEgg Accounts Point")]
        Add_NewEggAccounts_Point = 301401,

        //Sale 60
        //              so 06
        [Description("销售单生成 ")]
        Sale_SO_WebSite_Create = 0,
        [Description("销售单生成 ")]
        Sale_SO_WebSite_Submit = 200,
        [Description("销售单生成")]
        ...
        Sale_SO_Reject = 600625,
        [Description("已通关发往顾客")]
        Sale_SO_CustomsPass = 600626,
        [Description("通关失败订单作废")]
        Sale_SO_CustomsReject = 600627,
        ...
        [Description("AO-负收款单-退款")]
        AO_Refund_Refund = 705008,
    ...
    /// 部门的有效性状态
    /// </summary>
    public enum DepartmentValidStatus
    {
        Active,
        DeActive
    }
    ...
    /// 业务操作用户类型
    /// </summary>
    public enum BizOperationUserType
    {
        /// <summary>
        /// I
        /// </summary>
    ...
    /// 业务操作用户状态
    /// </summary>
    public enum BizOperationUserStatus
    {
        /// <summary>
        /// 无效状态
        /// </summary>
    ...
    /// ComboBox控件首选项模式
    /// </summary>
    public enum ComboBoxBlankItemMode
    {
        PleaseSelect,
        AllItem,
        None
    ...
    /// </summary>
    [Description("ECCentral.BizEntity.Enum.Resources.ResCommonEnum")]
    public enum DeliveryStatusFor24H
    {
        No,
        Yes
    }
    ...
    [Description("ECCentral.BizEntity.Enum.Resources.ResCommonEnum")]
    public enum ShipTypeProductType
    {
        /// <summary>
        /// 必选
        /// </summary>
    ...
    [Description("ECCentral.BizEntity.Enum.Resources.ResCommonEnum")]
    public enum ControlPanelUserStatus
    {
        /// <summary>
        /// 启用
        /// </summary>
