...
{
    [VersionExport(typeof(IControlPanelUserQueryDA))]
    public class ControlPanelUserQueryDA:IControlPanelUserQueryDA
    {
        public DataTable QueryUser(ControlPanelUserQueryFilter filter, out int totalCount)
        {
            CustomDataCommand command = DataCommandManager.CreateCustomDataCommandFromConfig("QueryCPUsers");
                ...
                command.CommandText, command, pagingInfo, "c.InDate Desc"))
            {
                ...
                enumList.Add("Status", typeof(ControlPanelUserStatus));
