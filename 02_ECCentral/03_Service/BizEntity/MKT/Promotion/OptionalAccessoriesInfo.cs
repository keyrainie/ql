...
namespace ECCentral.BizEntity.MKT 
{
    ...
    [Serializable]
    [DataContract]
    public class OptionalAccessoriesInfo : IIdentity, IWebChannel, ICompany 
    {
        public OptionalAccessoriesInfo()
        {
            this.Items = new List<OptionalAccessoriesItem>();
        }
        ...
        /// </summary>
        [DataMember]
        public List<OptionalAccessoriesItem> Items { get; set; }

        /// <summary>
        /// 待审核规则的商品毛利Check信息，供页面显示
        /// </summary>
        [DataMember]
        public List<string> DisplayApproveMsg { get; set; }
    }
    /// <summary>
    /// 套餐商品信息
    /// </summary>
    [Serializable]
    [DataContract]
    public class OptionalAccessoriesItem
    {
        /// <summary>
        /// 系统编号
        /// </summary>
        ...
        /// </summary>
        [DataMember]
        public int? OptionalAccessoriesSysNo { get; set; }
        /// <summary>
        /// 商品系统编号
        /// </summary>
        [DataMember]
        ...
        /// </summary>
        [DataMember]
        public decimal? DiscountPercentVal { get; set; }
        /// <summary>
        /// 是否为主商品
        /// </summary>
        [DataMember]
