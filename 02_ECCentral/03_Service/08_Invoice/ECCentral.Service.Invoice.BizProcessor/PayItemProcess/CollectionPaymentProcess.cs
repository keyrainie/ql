...
namespace ECCentral.Service.Invoice.BizProcessor.PayItemProcess
{
    ...
    /// 针对于代收代付结算单的处理
    /// </summary>
    [VersionExport(typeof(IProcess), new string[] { "CollectionPaymentProcess" })]
    [Export(typeof(ProcessBase))]                    
    public class CollectionPaymentProcess : ProcessBase
    {
        #region For Pay
        ...
        protected override void PreCheckForCreate(PayItemInfo entity)
        {
            ...
            CollectionPaymentInfo collectionSettlement = ExternalDomainBroker.GetCollectionPaymentInfo(entity.OrderSysNo.Value);
            ...
            entity.OrderStatus = (int?)collectionSettlement.Status;

            if (collectionSettlement.Status == POCollectionPaymentSettleStatus.Settled)
            {
            ...
            {
                ThrowBizException("PayItem_Create_SettleStatusInvalid2！");
            }
        ...
        protected override void ProcessReferencePayableInfoForCreate(PayItemInfo entity)
        {
            ...
            if (ReferencePayableInfo != null)
            {
                ...
                if (ReferencePayableInfo.PayStatus == PayableStatus.Abandon)
                {
                    ...
                    PayableBizProcessor.UpdatePayableEGPAndETP(ReferencePayableInfo);
            ...
            else
            {
                ...
                ReferencePayableInfo.Note = "Auto created CollectionPaymentPayItem!";
        ...
        protected override PayItemInfo PreCheckForCancelAbandon(PayItemInfo entity, out PayableInfo payableInfo)
        {
            ...
            if (collectionSettlement.SettleStatus == GatherSettleStatus.SET)
            {
                ...
                {
                    ThrowBizException("PayItem_CancelAbandon_VendorSettleOrderStatusSettledForWaitOrObtain");
                }
            }
            else
            {
                ThrowBizException("PayItem_CancelAbandon_VendorSettleOrderStatusNotSettledForWaitOrObtain");
            }
            return payItemInfo;
        }
