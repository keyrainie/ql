    ...
    public class BatchActionResult<T>
    {
        ...
        public string PromptMessage
        {
            get
            {
                ...
                msg.AppendLine(string.Format(ResouceManager.GetMessageString(InvoiceConst.ResourceTitle.BatchAction, "BatchAction_PromptTitleFormat"),
                    TotalCount,
                    SuccessList.Count,
                    FaultList.Count));
                ...
                {
                    //失败记录如下：
                    msg.AppendLine(ResouceManager.GetMessageString(InvoiceConst.ResourceTitle.BatchAction, "BatchAction_FailedPromptFormat"));
