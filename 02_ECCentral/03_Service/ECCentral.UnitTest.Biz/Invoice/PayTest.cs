...
namespace ECCentral.UnitTest.BizProcessor.Invoice
{
    ...
    {
        [TestMethod]
        public void Test_Invoice_LockByVendor()
        {
        ...
        [TestMethod]
        public void Test_Invoice_UnLockByVendor()
        {
            int vendorSysNo = 2347;
        ...
        [TestMethod]
        public void Test_Invoice_LockByVendorPM()
        {
            int vendorSysNo = 243;
        ...
        [TestMethod]
        public void Test_Invoice_UnLockByVendorPM()
        {
            int vendorSysNo = 243;
        ...
        [TestMethod]
        public void Test_Invoice_ObjectFactory()
        {
