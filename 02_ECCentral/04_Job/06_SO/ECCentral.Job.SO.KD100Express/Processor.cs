...
namespace ECCentral.Job.SO.KD100Express
{
        ...
        public void Run(JobContext context)
        {
            ...
            if (trackingNumberList != null && trackingNumberList.Count > 0)
            {
                ...
                for (int i = 0; i < trackingNumberList.Count; i = i + Cnt)
                {
                    ...
                    client.Query("/SO/Job/QueryTracking", new ExpressQueryEntity() { Type = ExpressType.KD100, TrackingNumberList = trackingNumberList }, out obj, out error);
                    //if (error != null)
                    //{
