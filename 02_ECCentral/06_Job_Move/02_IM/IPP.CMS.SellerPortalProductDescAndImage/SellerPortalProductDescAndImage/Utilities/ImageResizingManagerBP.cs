...
namespace IPP.ContentMgmt.SellerPortalProductDescAndImage.Utilities
{
    ...
    public class ImageResizingManagerBP
    {
        ...
        {
            get { return new Bitmap(ConfigurationManager.AppSettings["WaterMarkPath"]); }
        }

        //private Bitmap s_imagWatermark = null; new Bitmap(HostingEnvironment.ApplicationPhysicalPath + ConfigurationManager.AppSettings["watermarkPath"]);
        private static readonly Dictionary<int, Image> s_dictWaterMarks = new Dictionary<int, Image>();
        /// <summary>
        /// 根据所给的宽、高得到相应比例的水印
        /// </summary>
        ...
        private static Bitmap GetWatermark(int imageWidth, int imageHeight)
        {
            if (!s_dictWaterMarks.ContainsKey(imageWidth))
            {
                ...
                int resizedWidth = (int)(ImgWatermark.Width * precent);
                int resizedHeight = (int)(ImgWatermark.Height * precent);
        ...
        //to get the percent of the watermark
        ...
        public static Bitmap InsertWatermark(Image imgPhoto)
        {
            ...
            try
            {
                ...
                Image imgWatermark = GetWatermark(imgPhoto.Width, imgPhoto.Height);
