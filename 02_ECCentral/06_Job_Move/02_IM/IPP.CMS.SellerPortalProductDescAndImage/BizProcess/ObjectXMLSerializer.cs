...
namespace IPP.Oversea.CN.ContentManagement.BizProcess.Common
{
    ...
    public class ObjectXMLSerializer
    {
        ...
        /// added by Robert Wang, 2006-01-12
        /// </summary>
        /// <param name="type">type of the object to load</param>
        /// <param name="XMLFilePathName"></param>
        /// <returns>the loaded object</returns>
        public virtual Object Load(Type type, string XMLFilePathName)
        {
            return this.LoadFromDocumentFormat(type, XMLFilePathName, null);
        }
        ...
        /// <returns></returns>
        private Object LoadFromDocumentFormat(Type type,
            string XMLFilePathName, IsolatedStorageFile isolatedStorageFolder)
        {
            TextReader txrTextReader = null;
            Object obj = null;
