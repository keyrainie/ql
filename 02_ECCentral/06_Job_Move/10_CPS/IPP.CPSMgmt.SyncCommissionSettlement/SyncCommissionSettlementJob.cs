...
using IPPOversea.Invoicemgmt.SyncCommissionSettlement.Biz;
using Newegg.Oversea.Framework.JobConsole.Client;

namespace IPPOversea.Invoicemgmt.SyncCommissionSettlement
{

    public class SyncCommissionSettlementJob : IJobAction
    {
        #region member
        ...
        private static void Start()
        {
            ...
            try
            {
                ...
                //<--1.应付对账逻辑
                BizFacadeManager.SyncCommissionSettlement.CreateWorkFlow();
                BizFacadeManager.SyncCommissionSettlement.ProcessSyncCommissionSettlement();
                //-->
            }
            catch (Exception ex)
            {
