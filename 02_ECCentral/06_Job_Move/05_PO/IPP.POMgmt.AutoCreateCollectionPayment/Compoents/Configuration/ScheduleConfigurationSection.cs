...
namespace POASNMgmt.AutoCreateCollectionPayment.Compoents.Configuration
{
    internal sealed class ScheduleConfigurationSection : ConfigurationSection
    {
    ...
    internal sealed class ScheduleElement : ConfigurationElement
    {
    ...
    internal sealed class ScheduleElementCollection : ConfigurationElementCollection
    {
