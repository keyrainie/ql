...
public sealed class Settings
{
    ...
    public static string ExceptionMeil
    {
        get
        {
            return ConfigurationManager.AppSettings["ExceptionMeil"];
        }
    }

    public static string PORestFulBaseUrl
    {

        get
        {
            return ConfigurationManager.AppSettings["PORestFulBaseUrl"];
        }
    }
}
