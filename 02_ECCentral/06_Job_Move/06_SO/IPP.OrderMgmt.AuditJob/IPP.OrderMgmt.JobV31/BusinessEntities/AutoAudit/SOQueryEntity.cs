...
{
    public class SOQueryEntity : EntityBase
    {
        ...
        [DataMapping("GiftCardPay", DbType.Decimal)]
        ...
        [DataMapping("SoSplitType", DbType.String)]
        ...
        {
            return Math.Max((this.TotalAmount - this.PrepayAmt - this.GiftCardPay), 0M);
        }

        #region  SO CheckShipping
