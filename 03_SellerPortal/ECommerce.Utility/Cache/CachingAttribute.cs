...
namespace ECommerce.Utility
{
    ...
    public class CachingAttribute : OnMethodBoundaryAspect
    {
        ...
        public override bool CompileTimeValidate(MethodBase method)
        {
            ...
            {
                Message.Write(MessageLocation.Unknown, SeverityType.Error, "ER0001", "Cannot cache constructors. Method : '" + method.DeclaringType.FullName + "." + method.Name + "'");
                return false;
            }
            ...
            {
                Message.Write(MessageLocation.Unknown, SeverityType.Error, "ER0002", "Cannot cache void methods. Method : '" + method.DeclaringType.FullName + "." + method.Name + "'");
                return false;
            }
            ...
            for (int i = 0; i < parameters.Length; i++)
            {
                ...
                {
                    Message.Write(MessageLocation.Unknown, SeverityType.Error, "ER0003", "Cannot cache methods with out parameters. Method : '" + method.DeclaringType.FullName + "." + method.Name + "'");
                    return false;
                }
            }
