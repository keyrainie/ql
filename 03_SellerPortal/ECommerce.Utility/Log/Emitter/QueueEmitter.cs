...
namespace ECommerce.Utility
{
    internal class QueueEmitter : ILogEmitter
    {
        ...
        {
            Type t = Type.GetType("ECommerce.ServiceBus.Consumer.EventMapping, ECommerce.ServiceBus.Consumer", true);
        ...
        {
            Type t = Type.GetType("ECommerce.ServiceBus.Consumer.EventPublisher, ECommerce.ServiceBus.Consumer", true);
