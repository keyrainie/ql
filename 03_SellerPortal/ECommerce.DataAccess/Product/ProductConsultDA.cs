...
namespace ECommerce.DataAccess.Product
{
    public class ProductConsultDA
    {
        ...
        public static void BatchSetProductConsultStatus(List<int> items, string status, string currentUser)
        {
            ...
            DataCommand dataCommand = DataCommandManager.GetDataCommand("ProductConsult_BatchUpdateProductConsultStatus");
        ...
        /// <returns></returns>
        public static ProductConsultInfo LoadProductConsult(int sysNo)
        {
            DataCommand dataCommand = DataCommandManager.GetDataCommand("ProductConsult_GetProductConsultInfo");

            dataCommand.SetParameterValue("@SysNo", sysNo);

            return dataCommand.ExecuteEntity<ProductConsultInfo>();
        }
        ...
        {
            DataCommand dataCommand = DataCommandManager.GetDataCommand("ProductConsult_InsertProductConsultReply");

            dataCommand.SetParameterValue<ProductConsultReplyInfo>(item);
        ...
        /// <param name="sysNo">The system no.</param>
        /// <returns></returns>
        public static List<ProductConsultReplyInfo> GetProductConsultFactoryReply(int sysNo)
        {
            DataCommand dataCommand = DataCommandManager.GetDataCommand("ProductConsult_GetProductConsultFactoryReply");

            dataCommand.SetParameterValue("@ConsultSysNo", sysNo);

            CodeNamePairColumnList pairList = new CodeNamePairColumnList();
            pairList.Add("Type", "MKT", "ConsultCategory");//回复类型
            pairList.Add("Status", "MKT", "FactoryReplyStatus");
            DataTable dataTable = dataCommand.ExecuteDataTable(pairList);

            List<ProductConsultReplyInfo> list = new List<ProductConsultReplyInfo>();

            foreach (DataRow row in dataTable.Rows)
            {
                list.Add(DataMapper.GetEntity<ProductConsultReplyInfo>(row));
            }
